...
module tb_expr;
    ...
    task automatic check_case;
        ...
        begin
            ...
            // expr_plain: registered input (1 cycle) + registered result
            // (1 cycle) = 2 cycles latency.
            @(posedge clk); #1;
            @(posedge clk); #1;
            ...
            // expr_pipelined: one extra pipeline stage -> 1 MORE cycle
            // than expr_plain (3 total).
            @(posedge clk); #1;
